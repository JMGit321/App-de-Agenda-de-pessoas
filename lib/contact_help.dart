...
class ContactHelper{//singleton
  static final ContactHelper _instance = ContactHelper.internal();//construtor interneto
...
class Contact{
 ...
 @override//para poder da print na classe contato
  String toString() {
